...
public:
	...
	bool ENABLE_ADAPTIVE_FAILURE_DETECTION;
	double ADAPTIVE_FAILURE_DETECTION_MIN_DELAY;
	double ADAPTIVE_FAILURE_DETECTION_MAX_DELAY;
	double ADAPTIVE_FAILURE_DETECTION_SMOOTHING_FACTOR;
