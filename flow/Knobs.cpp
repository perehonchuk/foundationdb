...
void FlowKnobs::initialize(Randomize randomize, IsSimulated isSimulated) {
	...
	//connectionMonitor
	init( CONNECTION_MONITOR_LOOP_TIME,   isSimulated ? 1.5 : 2.5 ); if( randomize && BUGGIFY ) CONNECTION_MONITOR_LOOP_TIME = 6.0;
	init( CONNECTION_MONITOR_TIMEOUT,     isSimulated ? 3.0 : 5.0 ); if( randomize && BUGGIFY ) CONNECTION_MONITOR_TIMEOUT = 10.0;
