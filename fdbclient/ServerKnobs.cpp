...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( ENABLE_PER_REGION_FAILURE_MONITORING,                 true );
	init( REGION_FAILURE_THRESHOLD_PERCENTAGE,                  0.50 ); // 50% of workers in a region
	init( MIN_WORKERS_PER_REGION_FOR_MONITORING,                   5 );
