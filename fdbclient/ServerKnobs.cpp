...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	init( DATA_DISTRIBUTION_FAILURE_REACTION_TIME,              90.0 ); if( randomize && BUGGIFY ) DATA_DISTRIBUTION_FAILURE_REACTION_TIME = 1.0;
	...
	*/
	...
	init( WORKER_FAILURE_TIME,                                   2.0 ); if( randomize && BUGGIFY ) WORKER_FAILURE_TIME = 10.0;
