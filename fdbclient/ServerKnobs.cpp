...
void ServerKnobs::initialize(Randomize randomize, ClientKnobs* clientKnobs, IsSimulated isSimulated) {
	...
	*/
	...
	init( FETCH_KEYS_TRANSFERRED_VERSION_OFFSET,          10000000 ); if( randomize && BUGGIFY ) FETCH_KEYS_TRANSFERRED_VERSION_OFFSET = deterministicRandom()->randomInt64(1, 50000000);
