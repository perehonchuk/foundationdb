...
void ClientKnobs::initialize(Randomize randomize) {
	...
	init( ENCRYPT_HEADER_AES_GCM_NO_AUTH_VERSION,       1 );
	init( ENCRYPT_HEADER_AES_GCM_AES_CMAC_AUTH_VERSION, 1 );
	init( ENCRYPT_HEADER_AES_GCM_HMAC_SHA_AUTH_VERSION, 1 );
	init( ENCRYPT_CIPHER_MODE,                   "AES-256-CTR" );
