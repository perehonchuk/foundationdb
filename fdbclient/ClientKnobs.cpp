...
void ClientKnobs::initialize(Randomize randomize) {
	...
	init( ENABLE_TRANSACTION_CIRCUIT_BREAKER,     true );
	init( CIRCUIT_BREAKER_ERROR_THRESHOLD,           5 );
	init( CIRCUIT_BREAKER_TIMEOUT,                10.0 );
	init( CIRCUIT_BREAKER_HALF_OPEN_SUCCESS_THRESHOLD, 3.0 );
