...
void ClientKnobs::initialize(Randomize randomize) {
	...
	init( COMMIT_UNKNOWN_RESULT_CONDITIONAL_RETRY, true );
	init( MAX_COMMIT_UNKNOWN_RETRIES,                 3 ); if( randomize && BUGGIFY ) MAX_COMMIT_UNKNOWN_RETRIES = deterministicRandom()->randomInt(1, 5);
