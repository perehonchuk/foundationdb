...
public:
	...
	bool ENABLE_TRANSACTION_CIRCUIT_BREAKER;
	int CIRCUIT_BREAKER_ERROR_THRESHOLD;
	double CIRCUIT_BREAKER_TIMEOUT;
	double CIRCUIT_BREAKER_HALF_OPEN_SUCCESS_THRESHOLD;
