...
public:
	...
	int ENCRYPT_HEADER_AES_GCM_NO_AUTH_VERSION;
	int ENCRYPT_HEADER_AES_GCM_AES_CMAC_AUTH_VERSION;
	int ENCRYPT_HEADER_AES_GCM_HMAC_SHA_AUTH_VERSION;
	std::string ENCRYPT_CIPHER_MODE;
