...
struct CommitTransactionRequest : TimedRequest {
	...
	enum { FLAG_IS_LOCK_AWARE = 0x1, FLAG_FIRST_IN_BATCH = 0x2, FLAG_BYPASS_STORAGE_QUOTA = 0x4, FLAG_HIGH_PRIORITY = 0x8 };
	...
	bool isHighPriority() const { return (flags & FLAG_HIGH_PRIORITY) != 0; }
