...
env_set(FDB_ENABLE_VALGRIND OFF BOOL "Compile for valgrind usage")
env_set(FDB_ENABLE_VALGRIND_FOR_CTEST ${FDB_ENABLE_VALGRIND} BOOL "Use valgrind for ctest")
...
if(USE_ASAN OR FDB_ENABLE_VALGRIND OR USE_MSAN OR USE_TSAN OR USE_UBSAN)
...
if(WIN32)
  ...
  if (USE_AVX512F)
    ...
    elseif(FDB_ENABLE_VALGRIND)
      message(STATUS "FDB_ENABLE_VALGRIND=ON make USE_AVX OFF to satisfy valgrind analysis requirement")
      set(USE_AVX512F OFF)
    else()
