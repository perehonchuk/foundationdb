...
env_set(ENABLE_MEMCHECK_INSTRUMENTATION OFF BOOL "Compile with memcheck-friendly instrumentation (stack registration, relaxed SIMD)")
env_set(ENABLE_MEMCHECK_FOR_CTEST ${ENABLE_MEMCHECK_INSTRUMENTATION} BOOL "Use valgrind for ctest")
...
if(USE_ASAN OR ENABLE_MEMCHECK_INSTRUMENTATION OR USE_MSAN OR USE_TSAN OR USE_UBSAN)
...
if(WIN32)
  ...
  if(ENABLE_MEMCHECK_INSTRUMENTATION)
    list(APPEND SANITIZER_COMPILE_OPTIONS
      $<${is_cxx_compile}:-DBOOST_USE_VALGRIND>
      $<${is_cxx_compile}:-DFLOW_MEMCHECK>)

    list(APPEND BOOST_CXX_OPTIONS -DBOOST_USE_VALGRIND -DFLOW_MEMCHECK)
  endif()
  ...
  if (USE_AVX512F)
    ...
    elseif(ENABLE_MEMCHECK_INSTRUMENTATION)
      message(STATUS "ENABLE_MEMCHECK_INSTRUMENTATION=ON make USE_AVX OFF to satisfy memcheck analysis requirement")
      set(USE_AVX512F OFF)
    else()
