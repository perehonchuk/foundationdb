...
const Role Role::STORAGE_SERVER("StorageServer", "SV");
const Role Role::TESTING_STORAGE_SERVER("TestingStorageServer", "TV");
const Role Role::TRANSACTION_LOG("TLog", "TX");
const Role Role::SHARED_TRANSACTION_LOG("SharedTLog", "SX", false);
const Role Role::COMMIT_PROXY("CommitProxyServer", "CM");
const Role Role::GRV_PROXY("GrvProxyServer", "GV");
const Role Role::MASTER("MasterServer", "MT");
const Role Role::RESOLVER("Resolver", "RS");
const Role Role::CLUSTER_CONTROLLER("ClusterController", "CT");
const Role Role::TESTER("Tester", "TE");
const Role Role::LOG_ROUTER("LogRouter", "LG");
const Role Role::DATA_DISTRIBUTOR("DataDistributor", "DT");
const Role Role::RATEKEEPER("Ratekeeper", "RT");
const Role Role::STORAGE_CACHE("StorageCache", "SH");
const Role Role::COORDINATOR("Coordinator", "CR");
const Role Role::BACKUP("Backup", "BA");
const Role Role::ENCRYPT_KEY_PROXY("EncryptKeyProxy", "EK");
const Role Role::CONSISTENCYSCAN("ConsistencyScan", "CN");
