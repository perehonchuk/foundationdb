...
struct ConflictBatch {
	...
	void lightweightConflictPrefilter(Version now,
	                                  ...
	                                  std::vector<int>* tooOldTransactions = nullptr);
	// Second phase: priority-based conflict segmentation
	void priorityConflictSegmentation(Version now,
	                                  Version newOldestVersion,
	...
	// Third phase: comprehensive conflict check for segmented transactions
